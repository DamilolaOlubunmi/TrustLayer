...
function TopBar({ pageName, platform, status = "LIVE" }) {
  return (
    <header className="h-14 bg-white border-b border-gray-200 flex items-center justify-between px-6 flex-shrink-0">
      ...
      <div className="flex items-center gap-3">
        ...
        <button className="text-gray-400 hover:text-gray-600 cursor-pointer">⊙</button>
        <div className="w-8 h-8 rounded-full bg-blue-600 text-white flex items-center justify-center text-xs font-bold cursor-pointer">FM</div>
      </div>
    </header>
  );
}